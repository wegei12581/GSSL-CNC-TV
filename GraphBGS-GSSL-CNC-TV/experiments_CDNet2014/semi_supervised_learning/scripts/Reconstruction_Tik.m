...
%% Setting of paths
path_to_change_detection = 'D:/GraphBGS/CDNet2014/changedetection_dataset/'; % Change this line with your path to the change detection database
segmentation_algorithm = 'X_101_FPN_COCO';
background_inti_algorithm = 'median_filter';
construction_algorithm = 'k-NN-k-40';
semi_supervised_learning = 'Tik';
        ...
        for ii=1:repetitions
            ...
            for i=1:size(folder_challenges,1)
                for jj=1:size(folders_categories{i},1)
                    ...
                    %%
                    x_reconstructed_random = gsp_regression_tik(G,S_opt_random,...
