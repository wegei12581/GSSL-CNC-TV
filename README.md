...
In our demo, we analyzed the random graph generated by the function, and then processed the data using TV,Tikhonov, and CNC regularizer respectively. In conclusion, we compared the outcomes achieved by different models.
